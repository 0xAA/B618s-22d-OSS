cmd_scripts/basic/split-include := gcc -Wp,-MD,scripts/basic/.split-include.d  -w -Wstrict-prototypes -O2 -fomit-frame-pointer       -o scripts/basic/split-include scripts/basic/split-include.c  
