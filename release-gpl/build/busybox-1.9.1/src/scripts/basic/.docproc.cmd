cmd_scripts/basic/docproc := gcc -Wp,-MD,scripts/basic/.docproc.d  -w -Wstrict-prototypes -O2 -fomit-frame-pointer       -o scripts/basic/docproc scripts/basic/docproc.c  
