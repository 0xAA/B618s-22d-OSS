...
/*
 *      Global Variable definition for SMS module
 */
typedef enum tagATP_UTIL_GVAR_SMS_INDEX
{
    ATP_UTIL_GVAR_SMS_INIT = ATP_UTIL_GVAR_MOD_DEF(ATP_UTIL_GVAR_MOD_SMS),
    //TODO: add more index
    ATP_UTIL_GVAR_SMS_SRV,
}ATP_UTIL_GVAR_SMS_INDEX;
 ...
 *
 */
typedef enum tagATP_UTIL_GVAR_WLAN_INDEX
{
    ATP_UTIL_GVAR_WLAN_INIT = ATP_UTIL_GVAR_MOD_DEF(ATP_UTIL_GVAR_MOD_WLAN),
    ATP_UTIL_GVAR_WLAN_WLCONF,
    ATP_UTIL_GVAR_WLAN_WLMAP,
}ATP_UTIL_GVAR_WLAN_INDEX;
