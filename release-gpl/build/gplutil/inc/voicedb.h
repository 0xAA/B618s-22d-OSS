...
#define ATP_TAB_VOICE_300_LEN                                300
...
#define ATP_TAB_VOICE_ONLINECONTACT_NAME           "onlinecontact"
...
#define ATP_TAB_VOICE_HANDSETID_NAME      "handsetid"   /*missedcall,inacceptcall,internname */
...
{
    char         acNumber1[ATP_TAB_VOICE_300_LEN];                      /* fixed number*/
    char         ucNumber1_flags;
    char         acNumber2[ATP_TAB_VOICE_300_LEN];                      /* mobile number*/
    char         ucNumber2_flags;
    char         acNumber3[ATP_TAB_VOICE_300_LEN];                      /* work number*/   
...
typedef struct tagATP_VOICE_CFX_SRV_PARM_ST
{
    ...
    char acActiveCode[ATP_TAB_VOICE_MAX_NUMBER_LEN];    /*Activation code number*/
    char acDeactiveCode[ATP_TAB_VOICE_MAX_NUMBER_LEN];  /*Deactivation code number*/
    char acCfNumber[ATP_TAB_VOICE_300_LEN];      /*Call forwarding number*/
...
typedef struct tagATP_TAB_VOICE_MISSEDCALL_ST
{
    ...
    char      acNumber[ATP_TAB_VOICE_300_LEN];   /*calling number*/
    char      acName[ATP_TAB_VOICE_64_LEN];       /*calling name*/
    char      acDateTime[ATP_TAB_VOICE_DATETIME_LEN];   /*date and time of the call*/    
    char      acLineName[ATP_TAB_VOICE_300_LEN];   /*Indicates name of line used for the call*/
...
{
    VDB_ENTRY_ID    llEntryID;                              /*Entry identifie*/
    char            acName[ATP_TAB_VOICE_300_LEN];     /*Name of the line*/
    ...
    char            acBlockedNumber[ATP_TAB_VOICE_8_LEN]; /*syntax:"number1:number2:number3"*/
...
typedef struct tagATP_TAB_MOBILE_ST
{
    VDB_ENTRY_ID    llEntryID;                              /*Entry identifie*/
    int             lTerminalId;                            /*Terminal identity number*/
    /*TODO:mark by lijianhui*/
	char			acName[ATP_TAB_VOICE_MAX_NAME_LEN];     /*Name of the internal party*/
