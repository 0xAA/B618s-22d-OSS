...
#define PADN_CODE	0xd4
#define PTT_ACS_SRV	      __cpu_to_be16(0x0111) 
#define PTT_NTP_SRV	      __cpu_to_be16(0x0112) 
#define PTT_IP_ROUTE_ADD __cpu_to_be16(0x0121)
