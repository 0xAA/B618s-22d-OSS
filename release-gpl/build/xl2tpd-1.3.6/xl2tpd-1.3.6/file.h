...
#define DEFAULT_AUTH_FILE "/var/l2tp/l2tp-secrets"
#endif
#ifndef DEFAULT_CONFIG_FILE
#define DEFAULT_CONFIG_FILE "/etc/xl2tpd.conf"
#endif
#define ALT_DEFAULT_AUTH_FILE "/var/l2tp/l2tp-secrets"
...
struct lac
{
    ...
    int pap_refuse;             /* Refuse PAP authentication for us */
    int chap_refuse;            /* Refuse CHAP authentication for us */
    int mschap_require;         /* Require MSCHAP auth for PPP */
    int mschapv2_require;       /* Require MSCHAP-V2 auth for PPP */
    int mschap_refuse;          /* Refuse MSCHAP authentication for us */
    int mschapv2_refuse;        /* Refuse MSCHAP-V2 authentication for us */
    int mschap_encryalg;        /* Encryption algorithem for mschap,mschap-v2 */
    int idle;                   /* Idle timeout in seconds */
