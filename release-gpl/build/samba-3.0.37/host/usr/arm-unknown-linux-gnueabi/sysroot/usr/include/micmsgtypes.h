...
enum ATP_MIC_MSGTYPES_EN
{
    ...
    ATP_MSG_LUA_RESTORE_DEFAULT,  //lua脚本中恢复出厂
    ATP_MSG_LUA_DETECT,           //lua脚本中参数模型detect
    ATP_MSG_LUA_RESTORE_FINISH,   //恢复出厂的lua脚本执行完毕
    ATP_MSG_URLSEC_HASH,            //百度云获取hash值
    ATP_MSG_URLSEC_DOWNLOADSUCCESS, //百度云白名单下载成功
    ATP_MSG_URLSEC_DOWNLOADFAILED,  //百度云白名单下载失败
};
...
enum ATP_MICCORE_MSGTYPES_EN
{
    ...
    ATP_MSG_PROCD_EXITED,       // procd notify process exited
    ATP_MSG_PROCD_APK_VERIFY,   // do APK verification through procd
} ;
