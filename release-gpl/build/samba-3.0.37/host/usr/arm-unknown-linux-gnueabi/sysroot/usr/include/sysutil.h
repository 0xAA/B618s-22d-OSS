...
VOS_UINT32 ATP_UTIL_GetSysUpTime();
...
VOS_INT32 ATP_UTIL_Base64Decode(const VOS_UINT8* pucInput, VOS_INT32 lInputlen, VOS_UINT8** ppucOutput);
VOS_INT32 ATP_UTIL_Base64EncodeNew(const VOS_UINT8* pucInput, VOS_INT32 lInputlen, VOS_UINT8** ppucOutput);
...
VOS_UINT32 ATP_UTIL_Base64EncodeExNew(const VOS_UINT8* pucInput, VOS_UINT32 ulInputlen, VOS_UINT8** ppucOutput, VOS_UINT32 *pulOutputLen);
